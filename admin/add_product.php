...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // The first checked category is retained as the primary category for compatibility.
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="hidden" id="parent_category_id" name="parent_category_id" value="<?php echo (int)($_POST['parent_category_id'] ?? 0); ?>">
                                                <details class="border rounded bg-white product-category-dropdown">
                                                    ...
                                                    <div class="border-top py-2 product-category-menu">
                                                        <?php renderProductCategoryCheckboxes($categoryTree, $_POST['category_ids'] ?? []); ?>
                                                    </div>
                                                </details>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control" id="package_quantity" name="package_quantity" min="1" step="1" value="<?php echo htmlspecialchars($_POST['package_quantity'] ?? '1'); ?>">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="number" class="form-control" id="max_quantity_per_order" name="max_quantity_per_order" min="1" step="1" placeholder="Leave empty for no limit">
