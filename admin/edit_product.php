                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" class="form-control" name="pay_per_unit" step="any" min="0" inputmode="decimal" placeholder="e.g. 23.63" value="<?php echo htmlspecialchars(formatAdminNumberInput($product['pay_per_unit'] ?? '')); ?>">
